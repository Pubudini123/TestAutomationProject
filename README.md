...
This repository contains automated tests for a web application using C#, NUnit, Selenium WebDriver, and Protractor. The tests verify login functionality and ensure web application stability.
